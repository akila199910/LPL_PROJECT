...
<h4 style="text-align: center; color: #2980b9; font-weight: bold; text-decoration: underline;">REJECTED PLAYER LIST</h4><br><br>
      ...
      <td>  
       ...
       <td>
          <form action="profile2.php" method="POST">
            ...
            <button type="submit" name="view" class="bt">UPDATE</button>
              </form>
        </td>
