...
// Create wicketkeeper table if it doesn't exist
$sql4 = "CREATE TABLE IF NOT EXISTS wicketkeeper (
    player_keeping_id INT PRIMARY KEY AUTO_INCREMENT,
    b_style VARCHAR(255),
    lpl_nom INT(6),
    t20_nom INT(6),
    runs INT(6),
...
if (isset($_POST['submit'])) {
    ...
    $strike_rate = $_POST['strike_rate']; // Add this line for strike_rate
    ...
    $sql5 = "INSERT INTO wicketkeeper(`b_style`, `lpl_nom`, `t20_nom`, `runs`, `b_average`, `strike_rate`, `high_score`, `not_out`, 'fifty','hundred',`stumps`, `catch`, `sold`, `based_price`) VALUES 
    ('$b_style','$lpl_nom','$t20_nom','$runs','$b_average','$strike_rate','$high_score','$not_out','$fifty','$hundred','$stumps','$catch','$sold','$based_price')";
