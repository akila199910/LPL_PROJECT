...
<html>
<head>
<title>WicketkeeperDashboard</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-bar-block w3-tiny w3-hide-small w3-center">
  ...
  <a href="wicketkeeperdashboard.php" class="w3-bar-item w3-button w3-padding-large w3-hover-grey">
...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    ...
    <a href="playerprofile.php" class="w3-bar-item w3-button" style="width:25% !important">Perfomance</a>
...
<div id="main">
  ...
  <iframe src="wicketkeepercontain.php" width="100%" height="100%" frameborder="0"></iframe>
