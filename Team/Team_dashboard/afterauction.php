...
if ($bid_price > 0) {
    ...
    echo '  <div class="winer"><div class="win-container">
            <div class="box">
                <h2>Congratulations!</h2><br>';
                echo '<p style="font-size: 40px; font-family: \'Comic Sans MS\', cursive;"> ' . $teamname . "</p>";
    ...
    echo '<p style="font-size: 25px;">' . $PlayerCatogary . '
                ...
                <a href="../Team_dashboard/team_dashboard.php" class="btn btn-secondary btn-block mt-4">Exit</a>
